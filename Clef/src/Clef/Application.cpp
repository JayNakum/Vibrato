...
static Clef::Application* s_Instance = nullptr;
...
namespace Clef {
	...
	void Application::init()
	{
		...
		m_windowHandle = glfwCreateWindow(m_appSpecs.width, m_appSpecs.height, m_appSpecs.name.c_str(), NULL, NULL);
		...
		ImFont* robotoFont = io.Fonts->AddFontFromMemoryTTF((void*)g_comfortaaRegular, sizeof(g_comfortaaRegular), 20.0f, &fontConfig);
